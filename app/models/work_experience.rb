class WorkExperience < ApplicationRecord
  ...
  def job_duration
    months = end_date.present? ? fetch_months(end_date) : fetch_months(Date.today)

    result = months.divmod(12)    # gives array of 2 int => quotient and remainder q=no of years and r=no. of months
