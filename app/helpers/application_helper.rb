module ApplicationHelper
  # rails provide this helper class to manage complex opeartions from view and istaed u can write those opeartions here and then u can directly invoke the helper method on view template or partials
